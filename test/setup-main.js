 ...
 * Configures the testing environment for Electron main process modules
 */

// Mock electron module with direct implementation to avoid circular dependency
jest.mock(
  'electron',
  () => {
...
jest.mock(
  'fs',
  () => ({
    existsSync: jest.fn().mockReturnValue(true), // Default to file exists
